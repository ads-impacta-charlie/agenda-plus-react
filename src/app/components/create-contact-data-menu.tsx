...
export default function CreateContactDataMenu({data, index, onDelete}: CreateContactDataMenuParams) {
  ...
  return (
    <>
      ...
      <Menu anchorEl={dataMenuAnchorEl} open={open} onClose={handleDataMenuClose}>
